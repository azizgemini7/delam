...
class Product {
  ...
  Product.fromJson(Map<String, dynamic> json) {
    ...
    _images = json['images'] != null ? json['images'].cast<String>() : null;
    ...
    _rate = json['rate'] != null && double.tryParse(json['rate'].toString()) != null ? double.parse(json['rate'].toString()) : 0.0;
    if (json['rating'] != null) {
      _rating =  [];
  ...
  Map<String, dynamic> toJsonFireBase(id) {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    data['id'] = this._id;
    // data['id'] = "${id}";
    // data['added_by'] = this._addedBy;
...
class ProductFireBase extends Product{
  ProductFireBase(
      {int id,
      String addedBy,
      String userId,
      ...
      String featuredStatus,
      List<Rating> rating ,
      String rate}) : super(id, addedBy, userId, name, slug, categoryIds, brandId, unit, minQty, refundable, images, thumbnail, featured, flashDeal, videoProvider, videoUrl, colors, variantProduct, attributes, choiceOptions, variation, published, unitPrice, purchasePrice, tax, taxType, discount, discountType, currentStock, details, freeShipping, attachment, createdAt, updatedAt, status, featuredStatus, rating ,rate:  rate , categoryId : categoryId);
}
class CategoryIds {
  String _id;
  int _position;
