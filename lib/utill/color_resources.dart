...
class ColorResources {
  ...
  static Color getFloatingBtn(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFFFFC217) : Color(0xFFFFC217);
  }
  ...
  static const Color COLOR_PRIMARY = Color(0xffFFC217);
  ...
  static const Color ICON_BG = Color(0xffFFC217);
  ...
  static const Color FLOATING_BTN = Color(0xffFFC217);
  ...
  static const MaterialColor PRIMARY_MATERIAL = MaterialColor(0xFFFFC217, colorMap);
}
