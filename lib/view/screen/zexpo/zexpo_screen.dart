...
class ZexpoScreen extends StatelessWidget {
  final bool isBacButtonExist;
  ZexpoScreen({this.isBacButtonExist = true});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(children: [
        ...
        CustomAppBar(title: getTranslated('Zexpo', context), isBackButtonExist: isBacButtonExist),
