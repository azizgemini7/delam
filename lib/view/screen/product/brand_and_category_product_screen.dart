...
class BrandAndCategoryProductScreen extends StatelessWidget {
  ...
  final String name;
  final String image;
  BrandAndCategoryProductScreen({@required this.isBrand, @required this.id, @required this.name, this.image, products});
          ...
          return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            isBrand ? Container(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                ...
                Text(name != null ? name : "", style: titilliumSemiBold.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
              ]),
            ) : SizedBox.shrink(),
