...
class ProductDetailsFireBase extends StatelessWidget {
  final Product product;
  ProductDetailsFireBase({@required this.product});
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                ProductImageViewFireBase(productModel: product),

                ProductTitleViewFireBase(productModel: product),
                ...
                if(details.reviewList != null &&details.reviewList.isNotEmpty )
                // Reviews
                Container(
                  margin: EdgeInsets.only(top: Dimensions.PADDING_SIZE_SMALL),
                  padding: EdgeInsets.all(Dimensions.PADDING_SIZE_SMALL),
