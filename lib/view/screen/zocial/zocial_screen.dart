...
class ZocialScreen extends StatelessWidget {
  final bool isBacButtonExist;
  ZocialScreen({this.isBacButtonExist = true});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(children: [
        ...
        CustomAppBar(title: getTranslated('ZOCIAL', context), isBackButtonExist: isBacButtonExist),
