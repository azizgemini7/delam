                      ...
                      child: Padding(
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "${PriceConverter.convertPrice(context, double.parse(megaProvider.megaDealList[index].unitPrice),discountType: megaProvider.megaDealList[index].discountType, discount: megaProvider.megaDealList[index].discount)}",
                              ...
                              Row(children: [
                                Expanded(
                                  child: Text(
                                    '${double.parse(megaProvider.megaDealList[index].discount) > 0 ? double.parse(megaProvider.megaDealList[index].unitPrice) : " " }',
