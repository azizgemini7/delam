...
class BrandView extends StatelessWidget {
  final bool isDelamScreen;
  BrandView({@required this.isDelamScreen});
      ...
      builder: (context, brandProvider, child) {
        ...
        return brandProvider.brandList.length != 0 ? GridView.builder(
          ...
          itemCount: brandProvider.brandList.length != 0
              ...
              : 8,
          shrinkWrap: true,
          physics: isDelamScreen ? NeverScrollableScrollPhysics() : BouncingScrollPhysics(),
        ...
        ) : BrandShimmer(isDelamScreen: isDelamScreen);
...
class BrandShimmer extends StatelessWidget {
  final bool isDelamScreen;
  BrandShimmer({@required this.isDelamScreen});
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemCount: isDelamScreen ? 8 : 30,
      shrinkWrap: true,
      physics: isDelamScreen ? NeverScrollableScrollPhysics() : null,
      itemBuilder: (BuildContext context, int index) {
