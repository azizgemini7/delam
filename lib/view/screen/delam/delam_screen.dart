...
import 'package:sixvalley_ui_kit/view/screen/delam/widget/banners_view.dart';
import 'package:sixvalley_ui_kit/view/screen/delam/widget/brand_view.dart';
import 'package:sixvalley_ui_kit/view/screen/delam/widget/category_view.dart';
import 'package:sixvalley_ui_kit/view/screen/delam/widget/flash_deals_view.dart';
import 'package:sixvalley_ui_kit/view/screen/delam/widget/products_view.dart';
...
class DelamScreen extends StatelessWidget {
          ...
          slivers: [
            ...
            SliverToBoxAdapter(child: Column(
              children: [
                ...
                // Categories
                Padding(
                  padding: EdgeInsets.fromLTRB(Dimensions.PADDING_SIZE_LARGE, 20, Dimensions.PADDING_SIZE_SMALL, Dimensions.PADDING_SIZE_SMALL),
                ...
                Padding(
                  ...
                  child: CategoryView(isDelamScreen: true),
                ),
                ...
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL),
                  child: BrandView(isDelamScreen: true),
                ),
                ...
                Padding(
                  ...
                  child: Padding(
                    ...
                    child: ProductViewFirebase(productType: ProductType.LATEST_PRODUCT, scrollController: _scrollController),
                  ),
                ),
              ],
            ),)
