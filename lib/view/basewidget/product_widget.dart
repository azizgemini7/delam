          ...
          Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            Hero(
              ...
              child: Container(
                ...
                child: Image.asset(productModel.thumbnail),
              ),
            ),
...
class ProductWidgetFireBase extends StatelessWidget {
  final Product productModel;
  ProductWidgetFireBase({@required this.productModel});
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context, PageRouteBuilder(
          transitionDuration: Duration(milliseconds: 1000),
          pageBuilder: (context, anim1, anim2) => ProductDetailsFireBase(product: productModel),
        ));
      },
      child: Container(
        margin: EdgeInsets.all(5),
        ...
        child: Stack(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
            ...
            if(productModel.images != null && productModel.images.first != null)
            // Product Image
            Hero(
              tag: 'image-${productModel.id}',
              child: Container(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Hero(
                    tag: 'name-${productModel.id}',
                    child: Text(productModel.name ?? 'dd', style: robotoRegular, maxLines: 2, overflow: TextOverflow.ellipsis),
                  ),
                  SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
