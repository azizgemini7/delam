...
import 'data/repository/product_firebase_repo.dart';
...
Future<void> init() async {
  // Repository
  sl.registerLazySingleton(() => ProductFirebaseRepository());
  ...
  // Provider
  sl.registerFactory(() => ProductFirebaseProvider(productFirebaseRepo: sl()));
